...
import { fetchMyList } from "../friends/friendsSlice";
import { getAuth, loadUserRequest } from "../users/AuthSlice";
...
export const fetchSearchRequest = ({ places = [], batchs = [], depts = [] }) => async (dispatch) => {
    try {
